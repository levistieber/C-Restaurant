...
using Restaurant.HostBuilders;
using Restaurant.Models;
using Restaurant.Services;
using Restaurant.Services.ReservationConflictValidators;
using Restaurant.Services.ReservationCreators;
using Restaurant.Services.ReservationProviders;
...
namespace Restaurant
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            _host = Host.CreateDefaultBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddSingleton(new RestaurantDbContextFactory(connectionString));
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            RestaurantDbContextFactory RestaurantDbContextFactory = _host.Services.GetRequiredService<RestaurantDbContextFactory>();
            using (RestaurantDbContext dbContext = RestaurantDbContextFactory.CreateDbContext())
            {
